...
GenerateDPinputt2BamAC <- function(sampledir,participantid,tumourplatekey,normalplatekey,gender,vcffilepath,rhoandpsifilepath,subcloneshg38filepath,run) {
  ...
  if (file.exists(vcffilepath)) {
    ...
    print(paste("Using loci file",sampledir,dpcprepdir,tumourplatekey,"_loci.txt"))
    print(paste("Using allele frequencies file",sampledir,dpcprepdir,tumourplatekey,"_snv_counts_tumour.txt"))
    print(paste("Using cellularity file",sampledir,fitcopydir,tumourplatekey,"_rho_and_psi.txt"))
    print(paste("Using subclones file",sampledir,subdir,tumourplatekey,"_subclones_hg38.txt"))
    print(paste("Writing to output file",sampledir,dpcprepdir,samplename,"_DPinput.txt"))
