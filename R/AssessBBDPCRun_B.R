...
AssessBBDPCRun_B <- function(sampledir,participantid,tumourplatekey,normalplatekey,run,lowerclonal,upperclonal) {
  ...
  subfilename = paste0(sampledir,subdir,tumourplatekey,"_subclones.txt")
  message(file.exists(subfilename))
